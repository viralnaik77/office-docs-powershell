...
ms.assetid: ca0e1528-4e67-4e34-87db-e34e373df740

description: "Stops an instance of a search manager service."
---
...
|:-----|:-----|:-----|:-----|
|**Identity** <br/> |Required  <br/> |Microsoft.Office.Server.Search.Cmdlet.SearchManagerServiceInstancePipeBind  <br/> |Specifies the search manager service instance to stop.  <br/> The type must be a valid GUID, in the form 12345678-90ab-cdef-1234-567890bcdefgh; a valid SPServer name, or the name of a search manager service instance (for example, SearchManagerServiceInstance1); or an instance of a valid **SearchManagerServiceInstance** object.  <br/> |
