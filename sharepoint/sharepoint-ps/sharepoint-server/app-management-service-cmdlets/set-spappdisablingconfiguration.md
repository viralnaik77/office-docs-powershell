...
ms.assetid: faaf0df8-1e58-494b-9ffd-c3ed15a5560c

description: "Sets the disable list sync state for an app."
---
...
```
Set-SPAppDisablingConfiguration -Enable <$true | $false> [-AssignmentCollection <SPAssignmentCollection>] [-Confirm [<SwitchParameter>]] [-WhatIf [<SwitchParameter>]]
```
...
|:-----|:-----|:-----|:-----|
|**Enable** <br/> |Required  <br/> |System.Boolean  <br/> |Specifies whether to enable or disable an entry from the list.  <br/> |
