...
ms.assetid: 192378cc-7ddf-4b18-8154-3c67b56f84a6

description: "Completely deletes the specified service application proxy group."
---
...
```
Remove-SPServiceApplicationProxyGroup [-Identity] <SPServiceApplicationProxyGroupPipeBind> [-AssignmentCollection <SPAssignmentCollection>] [-Confirm [<SwitchParameter>]] [-WhatIf [<SwitchParameter>]]
```
...
|:-----|:-----|:-----|:-----|
|**Identity** <br/> |Required  <br/> |Microsoft.SharePoint.PowerShell.SPServiceApplicationProxyGroupPipeBind  <br/> |The identity of the service application proxy group to delete.  <br/> |
