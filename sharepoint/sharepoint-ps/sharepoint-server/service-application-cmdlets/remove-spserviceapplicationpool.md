---
title: "Remove-SPServiceApplicationPool"
ms.author: laurawi
author: LauraWi
manager: laurawi
ms.date: 3/9/2015
...
ms.assetid: e92510c1-0b33-4347-9eaa-d117f9af6cd3

description: "Completely deletes the specified Web service application pool."
---
...
```
Remove-SPServiceApplicationPool [-Identity] <SPIisWebServiceApplicationPoolPipeBind> [-AssignmentCollection <SPAssignmentCollection>] [-Confirm [<SwitchParameter>]] [-WhatIf [<SwitchParameter>]]
```
...
|:-----|:-----|:-----|:-----|
|**Identity** <br/> |Required  <br/> |Microsoft.SharePoint.PowerShell.SPIisWebServiceApplicationPoolPipeBind  <br/> |Specifies the identity of the Web service application pool to delete.  <br/> |
