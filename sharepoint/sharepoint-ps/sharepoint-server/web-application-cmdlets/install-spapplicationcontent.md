...
ms.assetid: 7d5a75c1-7f1a-43ab-9256-a2c699810d72

description: "Copies shared application data to existing Web application folders."
---
...
```
Install-SPApplicationContent [-AssignmentCollection <SPAssignmentCollection>]
```
